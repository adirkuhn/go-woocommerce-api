...
func (service *OrdersService) Create(ctx context.Context, order *Order) (*Order, *http.Response, error) {
	req, err := service.client.NewRequest(ctx, "POST", "/orders", nil, order)
	if err != nil {
		return nil, nil, err
	}
...
func (service *OrdersService) Get(ctx context.Context, orderID string, opts *GetOrderParams) (*Order, *http.Response, error) {
	req, err := service.client.NewRequest(ctx, "GET", "/orders/"+orderID, opts, nil)
	if err != nil {
		return nil, nil, err
	}
...
func (service *OrdersService) Update(ctx context.Context, orderID string, order *Order) (*Order, *http.Response, error) {
	req, err := service.client.NewRequest(ctx, "PUT", "/orders/"+orderID, nil, order)
	if err != nil {
		return nil, nil, err
	}
...
func (service *OrdersService) Delete(ctx context.Context, orderID string, opts *DeleteOrderParams) (*Order, *http.Response, error) {
	req, err := service.client.NewRequest(ctx, "DELETE", "/orders/"+orderID, opts, nil)
	if err != nil {
		return nil, nil, err
	}
...
func (service *OrdersService) Batch(ctx context.Context, opts *BatchOrderUpdate) (*BatchOrderUpdateResponse, *http.Response, error) {
	req, err := service.client.NewRequest(ctx, "POST", "/orders/batch", nil, opts)
	if err != nil {
		return nil, nil, err
	}
